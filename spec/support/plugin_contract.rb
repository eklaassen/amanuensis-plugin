...
module Amanuensis
  ...
  module PluginContractFixture
    ...
    class UnknownRoute < StandardError
    end
    ...
    def self.credential_for(method:, path:)
      ...
      when "pluginSecret"
        ...
        raise "unrecognised credential for #{method} #{path}"
      end
    end
    ...
    def self.schema_violations(method:, path:, body:)
      ...
      unless body.is_a?(Hash)
        return ["request body was missing or not an object (got #{body.class})"]
      end
        ...
        .each do |key, prop|
          ...
          ok =
            ...
            when "boolean"
              ...
              true # a type this checker doesn't model -- don't fail on it
            end
